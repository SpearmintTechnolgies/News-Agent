...
- **Verify before footer:** Run `python3 ~/.openclaw/workspace-mc-orchestrator/skills/pipeline/count_article_body_words.py --path <raw.md>`. The `[Word Count: N]` line must equal the script's `BODY_WORDS` exactly — never guess.
